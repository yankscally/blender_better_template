bl_info = {
    "name" : "BlenderBetterTemplate",
    "author" : "ys, Valy Arhal", # sign your name lol!
    "description" : "",
    "blender" : (4, 1, 0),
    "version" : (0, 0, 1),
    "location" : "",
...
from . import example_properties

def register_properties():
    # example:
    bpy.types.Scene.example_props = bpy.props.PointerProperty(type=example_properties.ExampleProperties)
    pass
